...
-- CUSTOMERS (500 rows)
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_DEV}}.ANALYTICS.CUSTOMERS;
INSERT INTO {{DB_DEV}}.ANALYTICS.CUSTOMERS
SELECT
    SEQ4()                                                          AS customer_id,
    CASE MOD(SEQ4(), 20)
...
-- PRODUCTS (100 rows)
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_DEV}}.ANALYTICS.PRODUCTS;
INSERT INTO {{DB_DEV}}.ANALYTICS.PRODUCTS
SELECT
    SEQ4()                                                                  AS product_id,
    CASE MOD(SEQ4(), 5)
...
-- STORES (20 rows)
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_DEV}}.ANALYTICS.STORES;
INSERT INTO {{DB_DEV}}.ANALYTICS.STORES
SELECT
    SEQ4()                                                  AS store_id,
...
-- ORDERS (5000 rows)
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_DEV}}.ANALYTICS.ORDERS;
INSERT INTO {{DB_DEV}}.ANALYTICS.ORDERS
SELECT
    SEQ4()                                                              AS order_id,
...
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_DEV}}.ANALYTICS.ORDER_ITEMS;
INSERT INTO {{DB_DEV}}.ANALYTICS.ORDER_ITEMS
SELECT
...
-- RETURNS (800 rows)
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_DEV}}.ANALYTICS.RETURNS;
INSERT INTO {{DB_DEV}}.ANALYTICS.RETURNS
SELECT
    SEQ4()                                                              AS return_id,
    UNIFORM(0, 4999, RANDOM())                                          AS order_id,
...
-- ============================================================
TRUNCATE TABLE IF EXISTS {{DB_PROD}}.ANALYTICS.CUSTOMERS;
TRUNCATE TABLE IF EXISTS {{DB_PROD}}.ANALYTICS.PRODUCTS;
TRUNCATE TABLE IF EXISTS {{DB_PROD}}.ANALYTICS.STORES;
TRUNCATE TABLE IF EXISTS {{DB_PROD}}.ANALYTICS.ORDERS;
TRUNCATE TABLE IF EXISTS {{DB_PROD}}.ANALYTICS.ORDER_ITEMS;
TRUNCATE TABLE IF EXISTS {{DB_PROD}}.ANALYTICS.RETURNS;
INSERT INTO {{DB_PROD}}.ANALYTICS.CUSTOMERS   SELECT * FROM {{DB_DEV}}.ANALYTICS.CUSTOMERS;
INSERT INTO {{DB_PROD}}.ANALYTICS.PRODUCTS    SELECT * FROM {{DB_DEV}}.ANALYTICS.PRODUCTS;
INSERT INTO {{DB_PROD}}.ANALYTICS.STORES      SELECT * FROM {{DB_DEV}}.ANALYTICS.STORES;
INSERT INTO {{DB_PROD}}.ANALYTICS.ORDERS      SELECT * FROM {{DB_DEV}}.ANALYTICS.ORDERS;
INSERT INTO {{DB_PROD}}.ANALYTICS.ORDER_ITEMS SELECT * FROM {{DB_DEV}}.ANALYTICS.ORDER_ITEMS;
INSERT INTO {{DB_PROD}}.ANALYTICS.RETURNS     SELECT * FROM {{DB_DEV}}.ANALYTICS.RETURNS;
