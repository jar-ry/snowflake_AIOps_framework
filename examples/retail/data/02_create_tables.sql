...
CREATE OR REPLACE PROCEDURE {{DB_DEV}}.ANALYTICS.CREATE_RETAIL_TABLES(db_name STRING)
RETURNS STRING
LANGUAGE SQL
AS
$$
...
CALL {{DB_DEV}}.ANALYTICS.CREATE_RETAIL_TABLES('{{DB_DEV}}');
CALL {{DB_DEV}}.ANALYTICS.CREATE_RETAIL_TABLES('{{DB_PROD}}');
