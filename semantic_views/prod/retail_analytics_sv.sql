-- ============================================================================
-- retail_analytics_sv.sql (PROD environment)
-- Identical structure but targets RETAIL_AI_PROD database
-- Only deployed after passing quality gates in TEST
-- ============================================================================

CREATE OR REPLACE SEMANTIC VIEW RETAIL_AI_PROD.SEMANTIC.RETAIL_ANALYTICS_SV
  COMMENT = 'Retail analytics semantic view for e-commerce data analysis'
AS SEMANTIC MODEL
  TABLES (
    RETAIL_AI_PROD.ANALYTICS.CUSTOMERS
      AS CUSTOMERS
    ...
    RETAIL_AI_PROD.ANALYTICS.PRODUCTS
      AS PRODUCTS
    ...
    RETAIL_AI_PROD.ANALYTICS.ORDERS
      AS ORDERS
    ...
    RETAIL_AI_PROD.ANALYTICS.ORDER_ITEMS
      AS ORDER_ITEMS
    ...
    RETAIL_AI_PROD.ANALYTICS.RETURNS
      AS RETURNS
    ...
    RETAIL_AI_PROD.ANALYTICS.STORES
      AS STORES
