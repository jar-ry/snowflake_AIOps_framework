...
-- ============================================================
-- Copy to TEST and PROD
-- ============================================================
CREATE TABLE IF NOT EXISTS RETAIL_AI_TEST.SEMANTIC.RETAIL_AGENT_EVAL_DATASET LIKE RETAIL_AI_DEV.SEMANTIC.RETAIL_AGENT_EVAL_DATASET;
TRUNCATE TABLE IF EXISTS RETAIL_AI_TEST.SEMANTIC.RETAIL_AGENT_EVAL_DATASET;
INSERT INTO RETAIL_AI_TEST.SEMANTIC.RETAIL_AGENT_EVAL_DATASET SELECT * FROM RETAIL_AI_DEV.SEMANTIC.RETAIL_AGENT_EVAL_DATASET;
...
CREATE STAGE IF NOT EXISTS RETAIL_AI_TEST.SEMANTIC.AGENT_EVAL_CONFIG_STAGE
    FILE_FORMAT = (TYPE = 'CSV' FIELD_DELIMITER = NONE);
...
GRANT USAGE ON STAGE RETAIL_AI_TEST.SEMANTIC.AGENT_EVAL_CONFIG_STAGE TO ROLE RETAIL_AI_DEPLOYER;
GRANT READ ON STAGE RETAIL_AI_TEST.SEMANTIC.AGENT_EVAL_CONFIG_STAGE TO ROLE RETAIL_AI_DEPLOYER;
GRANT WRITE ON STAGE RETAIL_AI_TEST.SEMANTIC.AGENT_EVAL_CONFIG_STAGE TO ROLE RETAIL_AI_DEPLOYER;

GRANT SELECT ON TABLE RETAIL_AI_TEST.SEMANTIC.RETAIL_AGENT_EVAL_DATASET TO ROLE RETAIL_AI_DEPLOYER;
GRANT SELECT ON TABLE RETAIL_AI_PROD.SEMANTIC.RETAIL_AGENT_EVAL_DATASET TO ROLE RETAIL_AI_DEPLOYER;

GRANT CREATE FILE FORMAT ON SCHEMA RETAIL_AI_TEST.SEMANTIC TO ROLE RETAIL_AI_DEPLOYER;
GRANT CREATE TASK ON SCHEMA RETAIL_AI_TEST.SEMANTIC TO ROLE RETAIL_AI_DEPLOYER;
GRANT EXECUTE TASK ON ACCOUNT TO ROLE RETAIL_AI_DEPLOYER;
GRANT CREATE DATASET ON SCHEMA RETAIL_AI_TEST.SEMANTIC TO ROLE RETAIL_AI_DEPLOYER;
